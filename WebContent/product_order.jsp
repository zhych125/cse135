...
<% 
    ...
    if(action!=null&&action.equals("add_order")) {
        ...
        added.setNum(Integer.parseInt(request.getParameter("number")));
...
<tr>
         ...
         <input type="hidden" name="product_id" value="<%=newProduct.getId()%>"/>
         <input type="hidden" name="name" value="<%=newProduct.getName() %>"/>
         <input type="hidden" name="SKU" value="<%=newProduct.getSKU() %>"/>
         <input type="hidden" name="category" value="<%=newProduct.getCategory() %>"/>
         <input type="hidden" name="category_id" value="<%=newProduct.getCategory_id() %>"/>
